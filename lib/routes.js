 ...
 * @returns `{ references, referenceFiles }`, each at most 16 entries.
 */
function referencesFromBody(body) {
  ...
  for (const item of raw) {
    if (referenceFiles.length >= 16) break
...
export { HISTORY_LIMIT, ROUTE_PREFIX, createRouteHandlers, publicModel, redact, referencesFromBody, registerRoutes }